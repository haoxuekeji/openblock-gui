...
class Blocks extends React.Component {
    ...
    handleConnectionModalStart (extensionId) {
        // A Scratch extension with its own peripheral (e.g. WeDo 2.0) opens
        // the modal for itself without taking over the selected hardware
        // device: writing its id into the device slot used to wipe the
        // device name/type (menu bar, code generation) and hijack the
        // device's connection indicator.
        this.props.onOpenConnectionModal(extensionId || null);
    }
    handleStatusButtonUpdate () {
